...
p_resistance <- ggplot(xbar_df_resistance, aes(x = x, y = y)) +
  ...
  labs(
    title = "X-bar.one Chart for PartResistance (Machine 3, 338K, 200kPa)",
    x = "Observation",
    y = "PartResistance"
  ) +
  theme_minimal() +
...
htmlwidgets::saveWidget(p_plotly_resistance, "media/plots/control_chart_machine_3_temp_338_pressure_200_partresistance.html", selfcontained = TRUE)

...
p_length_dist <- ggplot(filtered_data, aes(x = PartLength)) +
  ...
  labs(
    title = "Distribution of PartLength (Machine 2, 338K, 200kPa)",
    x = "PartLength",
    y = "Density"
  ) +
  theme_minimal() +
...
htmlwidgets::saveWidget(p_plotly_length_dist, "media/plots/distribution_partlength_machine_2_temp_338_pressure_200.html", selfcontained = TRUE)

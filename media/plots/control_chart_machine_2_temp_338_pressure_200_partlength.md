...
p_length <- ggplot(xbar_df_length, aes(x = x, y = y)) +
  ...
  labs(
    title = "X-bar.one Chart for PartLength (Machine 2, 338K, 200kPa)",
    x = "Observation",
    y = "PartLength"
  ) +
  theme_minimal() +
...
htmlwidgets::saveWidget(p_plotly_length, "media/plots/control_chart_machine_2_temp_338_pressure_200_partlength.html", selfcontained = TRUE)

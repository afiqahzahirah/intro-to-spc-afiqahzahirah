...
p <- ggplot(filtered_data, aes(x = PartLength)) +
  ...
  labs(
    title = "Distribution of PartLength (Machine 1, 338K, 200kPa)",
    x = "PartLength",
    y = "Density"
  ) +
  theme_minimal() +
...
htmlwidgets::saveWidget(p_plotly, "media/plots/distribution_partlength_machine_1_temp_338_pressure_200.html", selfcontained = TRUE)
